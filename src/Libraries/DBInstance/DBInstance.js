 ...
 */
const add = (databaseName, storeName, data, keyProperty) => {
...
/**
 * Replace an item in the specified store 
 * @param {any} data the data you wish to replace
 * @param {string} key of item to remove
 */
const replace = (key, store) => {
    console.log("replace kjørte")
}
